...
const SL_Xinming = React.lazy(() => import(/* webpackChunckName: "Example" */ './pages/YourShoppingListsHere/Xinming'))
...
function App() {
  ...
  const routes = (
    <Switch>
      ...
      <Route path={`${PATHS.MISSIONS}/1/Xinming`} exact component={SL_Xinming} />
